package com.jishi.daichao.permission.bean;
    ...
    public String getPermissionNameDesc() {
        ...
        switch (permissionName) {
            ...
            case Manifest.permission.WRITE_CALENDAR:
                desc = context.getResources().getString(R.string.kh_common_permission_calendar);
                break;
            case Manifest.permission_group.CAMERA:
            case Manifest.permission.CAMERA:
                desc = context.getResources().getString(R.string.kh_common_permission_camera);
                break;
            case Manifest.permission_group.CONTACTS:
            case Manifest.permission.READ_CONTACTS:
            case Manifest.permission.WRITE_CONTACTS:
            case Manifest.permission.GET_ACCOUNTS:
                desc = context.getResources().getString(R.string.kh_common_permission_contact);
                break;

            case Manifest.permission_group.PHONE:
            case Manifest.permission.CALL_PHONE:
            case Manifest.permission.READ_PHONE_STATE:
                desc = context.getResources().getString(R.string.kh_common_permission_call);
                break;

            case Manifest.permission_group.STORAGE:
            case Manifest.permission.WRITE_EXTERNAL_STORAGE:
            case Manifest.permission.READ_EXTERNAL_STORAGE:
                desc = context.getResources().getString(R.string.kh_common_permission_storage);
                break;
            case Manifest.permission_group.LOCATION:
            case Manifest.permission.ACCESS_FINE_LOCATION:
            case Manifest.permission.ACCESS_COARSE_LOCATION:
                desc = context.getResources().getString(R.string.kh_common_permission_location);
                break;
            // 麦克风和传感器未加，用到再加ai
            default:
                desc = context.getResources().getString(R.string.kh_common_permission_undefined);
                break;
        }
        return desc;
    }
